#############################################################################
# Makefile for building: ImageFilteringQt4
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat Mar 8 13:45:52 2014
# Project:  ImageFilteringQt4.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile ImageFilteringQt4.pro
#############################################################################
...
DIST          = /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		...
		ImageFilteringQt4.pro
QMAKE_TARGET  = ImageFilteringQt4
DESTDIR       = 
TARGET        = ImageFilteringQt4
...
Makefile: ImageFilteringQt4.pro  /usr/local/Cellar/qt/4.8.5/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt/4.8.5/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt/4.8.5/mkspecs/common/clang.conf \
	...
	$(QMAKE) -o Makefile ImageFilteringQt4.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/ImageFilteringQt41.0.0 || $(MKDIR) .tmp/ImageFilteringQt41.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/ImageFilteringQt41.0.0/ && $(COPY_FILE) --parents qt4display.h .tmp/ImageFilteringQt41.0.0/ && $(COPY_FILE) --parents filterQt4.cc qt4display.cc .tmp/ImageFilteringQt41.0.0/ && (cd `dirname .tmp/ImageFilteringQt41.0.0` && $(TAR) ImageFilteringQt41.0.0.tar ImageFilteringQt41.0.0 && $(COMPRESS) ImageFilteringQt41.0.0.tar) && $(MOVE) `dirname .tmp/ImageFilteringQt41.0.0`/ImageFilteringQt41.0.0.tar.gz . && $(DEL_FILE) -r .tmp/ImageFilteringQt41.0.0
...
filterQt4.o: filterQt4.cc qt4display.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o filterQt4.o filterQt4.cc
